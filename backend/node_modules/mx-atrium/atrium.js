...
var ChallengeImageOption = (function () {
    function ChallengeImageOption() {
    }
    ChallengeImageOption.getAttributeTypeMap = function () {
        return ChallengeImageOption.attributeTypeMap;
    };
    ChallengeImageOption.discriminator = undefined;
    ChallengeImageOption.attributeTypeMap = [
        {
            "name": "dataUri",
            "baseName": "data_uri",
            "type": "string"
    ...
    return ChallengeImageOption;
}());
exports.ChallengeImageOption = ChallengeImageOption;
...
var MerchantLocation = (function () {
    function MerchantLocation() {
    }
    MerchantLocation.getAttributeTypeMap = function () {
        return MerchantLocation.attributeTypeMap;
    };
    MerchantLocation.discriminator = undefined;
    MerchantLocation.attributeTypeMap = [
        {
            "name": "city",
            "baseName": "city",
            "type": "string"
...
var MerchantLocationResponseBody = (function () {
    function MerchantLocationResponseBody() {
    }
    MerchantLocationResponseBody.getAttributeTypeMap = function () {
        return MerchantLocationResponseBody.attributeTypeMap;
    };
    MerchantLocationResponseBody.discriminator = undefined;
    MerchantLocationResponseBody.attributeTypeMap = [
        {
...
exports.MerchantLocationResponseBody = MerchantLocationResponseBody;
var MerchantLocationsResponseBody = (function () {
    function MerchantLocationsResponseBody() {
    }
    MerchantLocationsResponseBody.getAttributeTypeMap = function () {
        return MerchantLocationsResponseBody.attributeTypeMap;
    };
    MerchantLocationsResponseBody.discriminator = undefined;
    MerchantLocationsResponseBody.attributeTypeMap = [
        {
...
exports.MerchantLocationsResponseBody = MerchantLocationsResponseBody;
...
var MerchantsResponseBody = (function () {
    function MerchantsResponseBody() {
    }
    MerchantsResponseBody.getAttributeTypeMap = function () {
        return MerchantsResponseBody.attributeTypeMap;
    };
    MerchantsResponseBody.discriminator = undefined;
    MerchantsResponseBody.attributeTypeMap = [
        {
            "name": "merchants",
            "baseName": "merchants",
            "type": "Array<Merchant>"
...
exports.MerchantsResponseBody = MerchantsResponseBody;
...
var MembersApi = (function () {
    ...
    MembersApi.prototype.readOAuthWindowURI = function (memberGuid, userGuid, referralSource, uiMessageWebviewUrlScheme) {
        var localVarPath = this.basePath + '/users/{user_guid}/members/{member_guid}/oauth_window_uri'
            .replace('{' + 'member_guid' + '}', encodeURIComponent(String(memberGuid)))
            .replace('{' + 'user_guid' + '}', encodeURIComponent(String(userGuid)));
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
...
var MerchantsApi = (function () {
    ...
    MerchantsApi.prototype.listMerchantLocations = function (merchantGuid) {
        var localVarPath = this.basePath + '/merchants/{merchant_guid}/merchant_locations'
    ...
    MerchantsApi.prototype.listMerchants = function () {
        var localVarPath = this.basePath + '/merchants';
        var localVarQueryParameters = {};
        var localVarHeaderParams = Object.assign({}, this.defaultHeaders);
        var localVarFormParams = {};
        var localVarUseFormData = false;
    ...
    MerchantsApi.prototype.readMerchantLocation = function (merchantGuid, merchantLocationGuid) {
        var localVarPath = this.basePath + '/merchants/{merchant_guid}/merchant_locations/{merchant_location_guid}'
            .replace('{' + 'merchant_guid' + '}', encodeURIComponent(String(merchantGuid)))
...
var AtriumClient = (function () {
    function AtriumClient(apiKey, clientID, basePath) {
        if (basePath === void 0) { basePath = defaultBasePath; }
