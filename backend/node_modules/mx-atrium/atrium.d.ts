...
export declare class ChallengeImageOption {
    'dataUri'?: string;
    'label'?: string;
    'value'?: string;
    static discriminator: string | undefined;
...
export declare class MerchantLocationResponseBody {
...
export declare class MerchantLocationsResponseBody {
...
export declare class MerchantsResponseBody {
...
export declare class MembersApi {
    ...
    readOAuthWindowURI(memberGuid: string, userGuid: string, referralSource?: string, uiMessageWebviewUrlScheme?: string): Promise<{
        response: http.IncomingMessage;
        body: MemberResponseBody;
    }>;
...
export declare class MerchantsApi {
    ...
    listMerchants(): Promise<{
        response: http.IncomingMessage;
        body: MerchantsResponseBody;
    }>;
    readMerchant(merchantGuid: string): Promise<{
        response: http.IncomingMessage;
        body: MerchantResponseBody;
    }>;
    readMerchantLocation(merchantGuid: string, merchantLocationGuid: string): Promise<{
        response: http.IncomingMessage;
        body: MerchantLocationResponseBody;
    }>;
}
...
export declare class AtriumClient {
    constructor(apiKey: string, clientID: string, basePath?: string);
